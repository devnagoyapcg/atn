        ...
        onload : function() {
            ...
            for (var i = 0; i < 5; i++) {
                this.items.push({
                    ...
                    lastname     : { text : "Gante"},
                    firstname    : { text : "Jess" },
                    middlename   : { text : "Dela Cruz" },
                    birthday     : { text : "02/11/2986" },
                    birthplace   : { text : "Occidental Mindoro" },
                    gender       : { text : "Male" },
                    daterecorded : { text : "07/28/2021" },
                    casetype     : { text : "Illegal possession of handsomeness" },
                    action       : { text : "Reported to officials" },
                    status       : { text : "Active" },
                    others       : { text : "What did you do?" }
                });
            }
        }
    });
